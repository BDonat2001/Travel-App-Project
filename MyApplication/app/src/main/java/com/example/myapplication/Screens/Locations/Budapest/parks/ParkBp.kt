package com.example.myapplication.Screens.Locations.Budapest.parks
...
@Composable
fun ParkBp(location: Location, navController: NavController) {
        ...
        LazyColumn(modifier = Modifier.weight(1f)) {
            ...
            item {
                ...
                location.reviews.forEach() { review ->
                    ReviewItem(review) //display each review
                }
            }
        }
    }
